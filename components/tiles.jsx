  ...
  return (
    <div>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.box}>
            ...
            <p>
              ...
              free to host your own web apps and be prepared to submit a demo of
              your projects to our judges!
            </p>
          </div>
          <div className={styles.box}>
      ...
      <div className={styles.boxOther}>
        ...
        <br />
        <p>
          No restrictions! Submit any project you create, you have full creative
          freedom to develop anything of your choosing. Besides being school
          approrpiate, the only requirement is to be realted to the theme.
        </p>
      </div>
    </div>
  );
